...
fn bind_sqlite_value<'q>(
    ...
    match value {
        ...
        SqlValue::Decimal(value) => query.bind(value.scaled_i64()),
        SqlValue::DecimalNull(_) => query.bind(Option::<i64>::None),
...
fn bind_postgres_value<'q>(
    ...
    match value {
        ...
        SqlValue::Float(value) => query.bind(*value),
        SqlValue::FloatNull => query.bind(Option::<f64>::None),
        SqlValue::Decimal(value) => query.bind(value.value()),
        SqlValue::DecimalNull(_) => query.bind(Option::<rust_decimal::Decimal>::None),
        SqlValue::Bool(value) => query.bind(*value),
        SqlValue::BoolNull => query.bind(Option::<bool>::None),
        SqlValue::Null => query.bind(Option::<String>::None),
    }
