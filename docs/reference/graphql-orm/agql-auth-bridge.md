...
```toml
graphql-orm = { git = "https://github.com/Dastari/graphql-orm.git", rev = "<reviewed-full-40-character-commit-sha>", version = "0.20.0", features = ["sqlite", "auth-agql"] }
...
package/type universes. Version 0.20.0 keeps the identity, role, scope, tenant,
