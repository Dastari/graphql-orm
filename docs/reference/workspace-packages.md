...
| --- | --- | --- | --- | --- |
| `graphql-orm` | `0.32.0` | `crates/graphql-orm` | `sqlite` | `graphql-orm-macros`, `graphql-orm-operation-catalog`, `graphql-orm-router-protocol` (dev-only) |
...
| `graphql-orm-macros` | `0.32.0` | `crates/graphql-orm-macros` | `sqlite` | none |
