---
title: "Storage Streaming And Range Boundary"
kind: investigation
status: accepted
...
> **Historical boundary investigation.** This record captures the 2026
> decision and API expectations at the ORM/storage boundary. It is not a
> substitute for the current package-local storage documentation.
