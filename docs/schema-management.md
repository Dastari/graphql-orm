...
Changing searchable fields, weights, language, tokenizer, or strategy changes the schema hash and
plans a search-index create/drop/recreate step.
...
searchable fields automatically after the structures exist.
