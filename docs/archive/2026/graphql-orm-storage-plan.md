...
> **Archived (2026-08-01).** This completed implementation plan is retained as
> historical context. Current provider work is tracked in
> [the storage-provider backlog](../../../docs/plans/backlog/storage-providers/README.md).
