---
title: "Consumer Project Migration Agent Prompt"
kind: reference
status: archived
...
> **Historical migration prompt.** This prompt records the completed 2026
> monorepo cutover and its original consumer migration procedure. It is kept as
> evidence, not current setup guidance; use the workspace documentation index
> and the package manifests for current dependency instructions.
