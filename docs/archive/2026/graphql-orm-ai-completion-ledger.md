...
> **Archived completion ledger (2026).** This is a historical record of the
> former crate-local execution plan. It no longer governs current work; use the
> [AI production-readiness plan](../../plans/active/ai-production-readiness/README.md)
> for active priorities and gates. Historical versions, handoffs, and delivery
> claims below are preserved as recorded.
...
[Implementation status](graphql-orm-ai-implementation-ledger.md) is authoritative for the
...
- Run branch CI and record the final downstream commit and CI result in
  [implementation status](graphql-orm-ai-implementation-ledger.md).
...
boundaries in [OpenAI background submission](../../../crates/graphql-orm-ai/docs/openai-background.md) and
[OpenAI webhook intake](../../../crates/graphql-orm-ai/docs/openai-webhooks.md). The design must cover:
...
[provider-persistent files](../../../crates/graphql-orm-ai/docs/provider-files.md). The design now specifies
...
see [canonical ordering and history](../../../crates/graphql-orm-ai/docs/ordering-history.md). The proof fixes the
...
[recovery, retention, backup, and restore](../../../crates/graphql-orm-ai/docs/recovery-and-restore.md). Ordinary
...
4; see [coordination gates](../../../crates/graphql-orm-ai/docs/coordination-gates.md). The paths currently admitted
...
[control-plane and production integration gates](../../../crates/graphql-orm-ai/docs/control-plane-production.md).
...
see the [backend and capability acceptance matrix](../../../crates/graphql-orm-ai/docs/backend-capability-matrix.md).
