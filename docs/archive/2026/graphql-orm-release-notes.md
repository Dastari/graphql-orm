...
> **Historical release-note ledger.** The root
> [`CHANGELOG.md`](../../../CHANGELOG.md) is the authoritative release chronology.
> This file is retained only as historical context for prior releases.
...
[Operation assurance](../../architecture/operation-assurance.md) and the
...
[Generated resolver operation metadata](../../reference/graphql-orm/resolver-operation-metadata.md) and
...
migration is required; see [the bridge guide](../../reference/graphql-orm/agql-auth-bridge.md) and
[the migration guide](../../../MIGRATION.md).
...
See [Runtime relations](../../reference/graphql-orm/runtime-relations.md),
[Schema management](../../reference/graphql-orm/schema-management.md), and
...
See [Runtime queries](../../reference/graphql-orm/runtime-queries.md) and
[MIGRATION.md](../../../MIGRATION.md). No schema/data or
...
See [Repository-only entities](../../reference/graphql-orm/repository-only-entities.md) and
[MIGRATION.md](../../../MIGRATION.md).
...
- Equivalent real backend tests cover all value kinds and prove logical record
  ...
  work; see [Runtime records](../../reference/graphql-orm/runtime-records.md).
...
- Hosts can define collections at runtime through an owned, validated,
  ...
  representation. See [Owned runtime schema IR](../../reference/graphql-orm/runtime-schema-ir.md).
...
- Append-only and keyset behavior is opt-in. Legacy mutable CRUD and offset connections remain
  available.
- PostgreSQL owners must run the disposable-database matrix documented in
