---
title: "graphql-orm Agent Brief: Backup And Restore Support"
kind: reference
status: archived
...
> **Archived (2026-08-01).** This implementation handoff describes the
> pre-0.17 integration surface and is retained as historical context only.
