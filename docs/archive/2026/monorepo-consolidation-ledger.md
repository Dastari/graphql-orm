...
> **Historical consolidation record.** The consolidation described here is
> complete. Its evidence is retained in the accompanying ledger; current
> workspace development guidance lives under `docs/development/`.
